    ...
    [
        (
            [
                ...
                LabelPrediction(token=",", label="O", start=38, end=39),
                LabelPrediction(token="34", label="B-VOLUME", start=40, end=42),
                LabelPrediction(token="##7", label="I-VOLUME", start=42, end=43),
                LabelPrediction(token="U", label="B-REPORTER", start=44, end=45),
                LabelPrediction(token=".", label="I-REPORTER", start=45, end=46),
                LabelPrediction(token="S", label="I-REPORTER", start=46, end=47),
                LabelPrediction(token=".", label="I-REPORTER", start=47, end=48),
                LabelPrediction(token="4", label="B-PAGE", start=49, end=50),
                LabelPrediction(token="##83", label="I-PAGE", start=50, end=52),
                LabelPrediction(token="(", label="O", start=53, end=54),
                LabelPrediction(token="1954", label="B-YEAR", start=55, end=59),
                LabelPrediction(token=")", label="O", start=60, end=61),
                LabelPrediction(token="[SEP]", label="I-CASE_NAME", start=62, end=63),
            ],
            ...
            [
                ...
                LabelPrediction(token="347", label="VOLUME", start=40, end=43),
                LabelPrediction(token="U.S.", label="REPORTER", start=44, end=48),
                LabelPrediction(token="483", label="PAGE", start=49, end=52),
                LabelPrediction(token="1954", label="YEAR", start=55, end=59),
            ],
        ),
    ],
)
